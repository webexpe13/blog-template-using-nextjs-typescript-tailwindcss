...
const ArticleDefaultLayout = () => {
    ...
    return (
        ...
        <BlogLayout layout={BlogLayouts.WITH_SIDEBAR}>
            ...
            */}
            <Para size={18}>
                For category crate a folder inside blog folder with you category name, like this article is under <b>tutorial</b> category, so we created a tutorial folder inside blog folder and created this article file inside the category folder. <br /><br />

                <b>* please note the path will also change in the ARTICLE_LIST in _ARTICLE_LIST.tsx file <br /> * {'/blog/{category}/{filename}'}</b>
            </Para>
            {/* 
