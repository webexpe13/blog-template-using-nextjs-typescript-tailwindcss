...
const FeaturedArticle = ({ article, path }: IProp) => {
    return (
        <>
            <div className={combineClasses(classes.featured_article, 'md:border-l-[5px] sm:border-t-[5px] md:border-t-0 border-blue-500 dark:bg-slate-800 dark:text-white dark:drop-shadow-lg')}>
