    ...
    return (
        <PageLayout PAGE_SEO={PAGE_SEO} home>
            <div className='container px-3 pb-[20px] mt-10 pt-14 md:pt-0'>
                ...
                <Text p>
                    At Stereo Punch, accessible from [Website_URL], one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Stereo Punch and how we use it. <br />
                    If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us. <br />
                    This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in Stereo Punch. This policy is not applicable to any information collected offline or via channels other than this website. Our Privacy Policy was created with the help of the Privacy Policy Generator.
                </Text>
                <Seperator line />
                ...
                <Text p>
                    Like any other website, Stereo Punch uses 'cookies'. These cookies are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users' experience by customizing our web page content based on visitors' browser type and/or other information. <br />
                ...
                <Text p>
                    You may consult this list to find the Privacy Policy for each of the advertising partners of Stereo Punch. <br />
                    ...
                    Note that Stereo Punch has no access to or control over these cookies that are used by third-party advertisers.
                </Text>
                <Seperator line />
                <Text subtitle className="text-xl">
                ...
                <Text p>
                Stereo Punch's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options. <br />
                ...
                <Text p >
                    ...
                    Stereo Punch does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.
                </Text>
            </div>
        </PageLayout>
    )
