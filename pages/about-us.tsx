      ...
      <section className="container px-3 md:pb-20 md:pt-10 pt-20">
        <div className="">
          ...
          <Text subtitle className="text-xl mb-5">
            This is an open source blog template which can help you start a
            simple static blog.
          </Text>

          <Text p className="text-lg">
            The idea was to start a blog or create a template with as little
            investment as possible. <br />
            In this template we have used Next.js SSG to create static HTML
            files which can be hosted on firebase or any static site hosting
            service. <br />
            There is also options like vercel for hosting Next.js dynamic
            webistes but we wanted this template to be easy to use for any non
            techie person too, so we explored the option of static site
            generation. <br />
            <br />
            If you have a github account you can clone the project or use it as
            a template or else you can simply download the code from{" "}
            <a
          ...
          <Text p className="text-lg">
            ...
            Feel free to open an issue, if you have any questions or incase you
            find a bug. Create your versions of this template and help the
            community, also if you are using our template a little credit will
            be much appreciated.
          </Text>
          <Seperator />
          <Text p className="text-lg">
          ...
          <a
            href="https://www.buymeacoffee.com/webexpe13z"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Image
